...
export interface ApiArtistArtist extends Schema.CollectionType {
  ...
  attributes: {
    ...
    artist_albums: Attribute.Relation<
      'api::artist.artist',
      'oneToMany',
      'api::artist-album.artist-album'
    > &
      Attribute.Private;
...
export interface ApiArtistAlbumArtistAlbum extends Schema.CollectionType {
  ...
  attributes: {
    ...
    artworks: Attribute.Relation<
      ...
      'api::artwork.artwork'
    >;
    slug: Attribute.UID<'api::artist-album.artist-album', 'collection'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiArtworkArtwork extends Schema.CollectionType {
  ...
  attributes: {
    artist_album: Attribute.Relation<
      'api::artwork.artwork',
      'manyToOne',
      'api::artist-album.artist-album'
    >;
    arts: Attribute.Media;
    artist: Attribute.Relation<
      'api::artwork.artwork',
      'manyToOne',
      'api::artist.artist'
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::artist-album.artist-album': ApiArtistAlbumArtistAlbum;
